...
//edit
#define USER_MC_CONF	"motor2.h"
#define USER_APP_CONF	"app2.h"
...
typedef struct{
	UART_HandleTypeDef huartx1;
	UART_HandleTypeDef huartx2;
	UART_HandleTypeDef huartx3;
	UART_HandleTypeDef huartx4;
...
//	return last_current_sample * fabsf(dutycycle_now);
//}
//
//float mcpwm_foc_get_tot_current_in(void) {
//	return (motor_all_state_t) m_motor_1->m_motor_state.i_bus;
//}
//mc_interface.c
...
typedef enum {
	...
	CAN_PACKET_SHUTDOWN,	//for mkx version
	...
	CAN_PACKET_STATUS_11,
	CAN_PACKET_STATUS_12,
